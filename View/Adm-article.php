...
<head>
    ...
    <title>BlogPam | Gestion Des Articles</title>
</head>
    ...
    <div class="adm-desktop">
        ...
        <div class="adm-desk">
            <div class="menu-adm">
                <div class="nav-adm">
                    <ul>
                        <li><a href="Adm-system.html">Statistique</a></li>
                        <li><a id="wh"  href="Adm-article.html">Article</a></li>
                        <li><a href="Adm-user.html">Utilisateur</a></li>
                    </ul>
                </div>
            </div>
            <div class="menu-block" id="style-3">
                <div class="container">
                    <ul class="navigation">
                        <li><a id="tab-nav-1" class="nav" data-tab="tab-1" href="#">Mes Articles</a></li>
                        <li><a id="tab-nav-2" class="nav default" data-tab="tab-2" href="#">Creer Articles</a></li>
                    </ul>
                    ...
                    <div class="wrapper-tabs">
                        <div id="tab-1" class="tab-item ">
                            <div class="article-adm">
                                <div class="divi">
                                    <h4>Titre Article</h4>
                                    <a href=""><img src="ICONES/icons8_Eye_24px_1.png" alt=""></a>
                                    <a href=""><img src="ICONES/icons8_Edit_File_24px.png" alt=""></a>
                                    <a href=""><img src="ICONES/icons8_Delete_24px_1.png" alt=""></a>
                                </div>
                                <div class="divi">
                                    <h4>Titre Article</h4>
                                    <a href=""><img src="ICONES/icons8_Eye_24px_1.png" alt=""></a>
                            ...
                            <div class="article-adm">
                                <div class="divi">
                                    <h4>Titre Article</h4>
                                    <a href=""><img src="../assets/ICONES/icons8_Eye_24px_1.png" alt=""></a>
                                    <a href=""><img src="../assets/ICONES/icons8_Edit_File_24px.png" alt=""></a>
                                    <a href=""><img src="../assets/ICONES/icons8_Delete_24px_1.png" alt=""></a>
                                </div>
                                <div class="divi">
                                    <h4>Titre Article</h4>
                                    <a href=""><img src="../assets/ICONES/icons8_Eye_24px_1.png" alt=""></a>
                        ...
                        <div id="tab-2" class="tab-item hide">
                            <form action="" >
                                <div class="newPost">
                                    <h3>Veuillez Saisir Le Titre de L'article</h3>
                                    ...
                                    <div class="buttons">
                                      ...
                                      <button type="submit" data-func="save" type="button">Creer</button>
